...
class Board:
    ...
    def draw(self, game_over = False):
        ...
        try:
            remove_file('.\\images\\to_disp' + str(Board.i) + '.png')
        except:
            pass
...
################################################################################
        ...
        self.intro_Box2 = BoxLayout(orientation='horizontal', size_hint=(1, .1))
        ...
        self.intro_Box2.add_widget(Label(text = 'Choose the number of player(s) : ', size_hint = (.3, 1)))
        self.intro_Box2.add_widget(Label(text = 'Choose the color of the 1st player : ', size_hint = (.32, 1)))
        self.intro_Box2.add_widget(Label(text = 'Choose the level of the ai :', size_hint = (.25, 1)))
...
################################################################################
        ...
        self.col_input = BoxLayout(
            orientation='horizontal', size_hint=(.45, 1))
...
################################################################################
    ...
    def PLAY(self, col):
        ...
        if isinstance (self.player1, Player) and isinstance (self.player2 , Player ): self.turn= 1-self.turn
